...
import ua.divas.model.RkoImpl;
// ---------------------------------------------------------------------
// ---    File generated by Oracle ADF Business Components Design Time.
// ---    Sun Apr 19 14:01:40 EEST 2015
...
public class RkoViewRowImpl extends ViewRowImpl {
    ...
    protected void create(AttributeList attributeList) {
        this.setREditable(new BigDecimal(1));
     ...
     */
    public RkoViewRowImpl() {
    }

    /**
     * Gets Rko entity object.
     * @return the Rko
     */
    public RkoImpl getRko() {
        return (RkoImpl) getEntity(ENTITY_RKO);
    }
    ...
    /**
     * Gets the attribute value for the calculated attribute REditable.
     * @return the REditable
     */
    public BigDecimal getREditable() {
        return (BigDecimal) getAttributeInternal(REDITABLE);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute REditable.
     * @param value value to set the  REditable
     */
    ...
    /**
     * Gets the associated <code>RowIterator</code> using master-detail link VwRkoMoves.
     */
    public RowIterator getVwRkoMoves() {
        return (RowIterator) getAttributeInternal(VWRKOMOVES);
    }
    ...
    /**
     * Gets the view accessor <code>RowSet</code> OperationRkoView1.
     */
    public RowSet getOperationRkoView1() {
        return (RowSet) getAttributeInternal(OPERATIONRKOVIEW1);
    }
