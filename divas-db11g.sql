...
-- Дата скрипта: 16.07.2015 15:49:15
-- Версия сервера: Oracle Database 11g Enterprise Edition Release 11.2.0.1.0 - 64bit Production With the Partitioning, OLAP, Data Mining and Real Application Testing options
-- Версия клиента: 
--


CREATE SEQUENCE DBA_DIVAS.START_OST_NUM_SEQ
START WITH 1
INCREMENT BY 1
...
CREATE SEQUENCE DBA_DIVAS.RKO_NUM_SEQ
START WITH 1
INCREMENT BY 1
MAXVALUE 1000000000000000000000000000
MINVALUE 1
...
CREATE SEQUENCE DBA_DIVAS.PS_TXN_SEQ
START WITH 1
INCREMENT BY 50;

CREATE SEQUENCE DBA_DIVAS.PROFIT_DISTRIB_NUM_SEQ
START WITH 1
INCREMENT BY 1
MAXVALUE 1000000000000000000000000000
MINVALUE 1
...
CREATE SEQUENCE DBA_DIVAS.PKO_NUM_SEQ
START WITH 1
INCREMENT BY 1
MAXVALUE 1000000000000000000000000000
MINVALUE 1
...
CREATE SEQUENCE DBA_DIVAS.OTHER_ZATR_NUM_SEQ
START WITH 1
INCREMENT BY 1
MAXVALUE 1000000000000000000000000000
MINVALUE 1
...
CREATE SEQUENCE DBA_DIVAS.ORDERS_NUM_SEQ
START WITH 1
INCREMENT BY 1
MAXVALUE 1000000000000000000000000000
MINVALUE 1
...
CREATE OR REPLACE TYPE DBA_DIVAS."USERTYPE"
  AS
...
CREATE OR REPLACE TYPE DBA_DIVAS."DIVISIONTYPE"
  AS
  OBJECT (n VARCHAR2(50),
          u_name VARCHAR2(1000));
/
...
CREATE OR REPLACE TYPE DBA_DIVAS."ROW_ZATRATY"
  AS
...
CREATE OR REPLACE TYPE DBA_DIVAS."ROW_SALES"
  AS
...
CREATE OR REPLACE TYPE DBA_DIVAS."ROW_BALLANS"
  AS
...
CREATE OR REPLACE TYPE DBA_DIVAS."KONTRAGTYPE"
  AS
  OBJECT (n VARCHAR2(50),
          u_name VARCHAR2(1000),
          root NUMBER);
...
CREATE OR REPLACE TYPE DBA_DIVAS."ROW_RATING"
  AS
  OBJECT (PLACE NUMBER,
          DIVISION_ID VARCHAR2(50 CHAR),
          CNT NUMBER,
...
CREATE OR REPLACE TYPE DBA_DIVAS."ROW_TABLE_REFERENCE"
  AS
...
CREATE OR REPLACE TYPE DBA_DIVAS."ROW_REFERENCE"
  AS
...
CREATE OR REPLACE TYPE DBA_DIVAS."ROW_TABLE_DELETED"
  AS
  OBJECT (TABLE_ID VARCHAR2(50),
          MAIN_ID VARCHAR2(50),
          TABLE_NAME VARCHAR2(30),
...
CREATE OR REPLACE TYPE DBA_DIVAS.USERTABLE AS
TABLE OF DBA_DIVAS.USERTYPE;
/

CREATE OR REPLACE TYPE DBA_DIVAS.DIVISIONTABLE AS
TABLE OF DBA_DIVAS.DIVISIONTYPE;
/

CREATE OR REPLACE TYPE DBA_DIVAS.TBL_ZATRATY AS
TABLE OF DBA_DIVAS.ROW_ZATRATY;
/

CREATE OR REPLACE TYPE DBA_DIVAS.TBL_SALES AS
TABLE OF DBA_DIVAS.ROW_SALES;
/

CREATE OR REPLACE TYPE DBA_DIVAS.TBL_BALLANS AS
TABLE OF DBA_DIVAS.ROW_BALLANS;
/

CREATE OR REPLACE TYPE DBA_DIVAS.KONTRAGTABLE AS
TABLE OF DBA_DIVAS.KONTRAGTYPE;
/

CREATE OR REPLACE TYPE DBA_DIVAS.TBL_RATING AS
TABLE OF DBA_DIVAS.ROW_RATING;
/

CREATE OR REPLACE TYPE DBA_DIVAS.TBL_REFERENCE AS
TABLE OF DBA_DIVAS.ROW_TABLE_REFERENCE;
/

CREATE OR REPLACE TYPE DBA_DIVAS.TBL_REF_TAB AS
TABLE OF DBA_DIVAS.ROW_REFERENCE;
/

CREATE OR REPLACE TYPE DBA_DIVAS.TBL_DELETED AS
TABLE OF DBA_DIVAS.ROW_TABLE_DELETED;
/

CREATE OR REPLACE TYPE DBA_DIVAS.TBL_DELETED_REF AS
TABLE OF DBA_DIVAS.ROW_TABLE_DELETED;
/
...
CREATE TABLE DBA_DIVAS.BASE_OF_CALC (
  ID       VARCHAR2(50 CHAR)  NOT NULL,
...
CREATE TABLE DBA_DIVAS.CALENDAR (
  ID          VARCHAR2(50 CHAR)  NOT NULL,
...
CREATE TABLE DBA_DIVAS.DIR_FILE_UPLOAD (
  ID        VARCHAR2(50 CHAR)  NOT NULL,
...
CREATE TABLE DBA_DIVAS.GROUPS (
  ...
  CONSTRAINT GROUPS_PK PRIMARY KEY (ID) USING INDEX (CREATE UNIQUE INDEX DBA_DIVAS.USERS_GROUP_PK ON DBA_DIVAS.GROUPS (ID) STORAGE (INITIAL 64 K
                                                                                                                                    NEXT 1 M
...
CREATE TABLE DBA_DIVAS.NOMENKLATURA (
  ...
  REFERENCES DBA_DIVAS.NOMENKLATURA (ID)
)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
...
CREATE INDEX DBA_DIVAS.ORDER_STATUS_INDEX1 ON DBA_DIVAS.ORDER_STATUS (NAME)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;
...
CREATE TABLE DBA_DIVAS.PS_TXN (
  ...
  CONSTRAINT PS_TXN_PK PRIMARY KEY (COLLID, ID) USING INDEX (CREATE INDEX DBA_DIVAS.PS_TXN_IDX ON DBA_DIVAS.PS_TXN (COLLID, ID) REVERSE STORAGE (INITIAL 64 K
                                                                                                                                                 NEXT 1 M
                                                                                                                                                 MAXEXTENTS UNLIMITED) LOGGING)
)
STORAGE (INITIAL 64 K
...
CREATE TABLE DBA_DIVAS.QUARTZ_PROPERTY (
  ID               VARCHAR2(50 CHAR) NOT NULL,
...
CREATE TABLE DBA_DIVAS.WLS_SETTINGS (
  ID       VARCHAR2(50 CHAR)  NOT NULL,
...
CREATE TABLE DBA_DIVAS.ZATRATY (
  ...
  REFERENCES DBA_DIVAS.ZATRATY (ID)
)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
...
CREATE TABLE DBA_DIVAS.OPERATION_RKO (
  ID       VARCHAR2(50 CHAR) NOT NULL,
  NAME     VARCHAR2(50 CHAR) NOT NULL,
  FULLNAME VARCHAR2(50 CHAR) NOT NULL,
...
CREATE TABLE DBA_DIVAS.OPERATION_PKO (
  ID       VARCHAR2(50 CHAR) NOT NULL,
  NAME     VARCHAR2(50 CHAR) NOT NULL,
  FULLNAME VARCHAR2(50 CHAR) NOT NULL,
...
CREATE TABLE DBA_DIVAS.BASE_OF_NACHISL (
  ID       VARCHAR2(50 CHAR)  NOT NULL,
  NAME     VARCHAR2(20 CHAR)  NOT NULL,
  FULLNAME VARCHAR2(100 CHAR) NOT NULL,
...
CREATE TABLE DBA_DIVAS.PROG_SETTINGS (
  ID                VARCHAR2(50 CHAR) NOT NULL,
  DATE_AFTER        DATE,
...
CREATE TABLE DBA_DIVAS.RATING_SETTINGS (
  ID          VARCHAR2(50 CHAR) NOT NULL,
...
CREATE TABLE DBA_DIVAS.DIVISIONS (
  ...
  REFERENCES DBA_DIVAS.DIVISIONS (ID),
  CONSTRAINT DIVISIONS_FK1 FOREIGN KEY (MAIN_USER)
  REFERENCES DBA_DIVAS.USERS (ID) ON DELETE SET NULL
)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
...
CREATE INDEX DBA_DIVAS.DIVISIONS_INDEX1 ON DBA_DIVAS.DIVISIONS (IS_GROUP, DELETED)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;
...
CREATE TABLE DBA_DIVAS.EX_RATES_SETTINGS (
  ...
  REFERENCES DBA_DIVAS.CURRENCY (ID),
...
CREATE TABLE DBA_DIVAS.GROUPMEMBERS (
  ...
  REFERENCES DBA_DIVAS.GROUPS (FULLNAME) ON DELETE CASCADE
)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
...
CREATE TABLE DBA_DIVAS.KONTRAGENTS (
  ...
  REFERENCES DBA_DIVAS.KONTRAGENTS (ID)
)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
...
CREATE TABLE DBA_DIVAS.NUMERATOR (
  ...
  REFERENCES DBA_DIVAS.TYPE_DEF (ID)
)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
...
CREATE TABLE DBA_DIVAS.PLAN_ACC (
  ...
  REFERENCES DBA_DIVAS.PLAN_ACC (ID),
  CONSTRAINT PLAN_ACC_FK2 FOREIGN KEY (ACC_TYPE)
  REFERENCES DBA_DIVAS.ENUM_ACCOUNT_TYPE (ID),
...
CREATE INDEX DBA_DIVAS.PLAN_ACC_INDEX1 ON DBA_DIVAS.PLAN_ACC (ACC_TYPE)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;

CREATE INDEX DBA_DIVAS.PLAN_ACC_INDEX2 ON DBA_DIVAS.PLAN_ACC (CODE)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;
...
CREATE TABLE DBA_DIVAS.QRTZ_TRIGGERS (
  ...
  JOB_DATA       BLOB,
  CONSTRAINT QRTZ_TRIGGERS_PK PRIMARY KEY (SCHED_NAME, TRIGGER_NAME, TRIGGER_GROUP) USING INDEX (CREATE INDEX DBA_DIVAS.IDX_QRTZ_T_N_STATE ON DBA_DIVAS.QRTZ_TRIGGERS (SCHED_NAME, TRIGGER_NAME, TRIGGER_GROUP, TRIGGER_STATE) STORAGE (INITIAL 64 K
                                                                                                                                                                                                                                        NEXT 1 M
                                                                                                                                                                                                                                        MAXEXTENTS UNLIMITED) LOGGING),
  CONSTRAINT QRTZ_TRIGGER_TO_JOBS_FK FOREIGN KEY (SCHED_NAME,
  JOB_NAME,
  JOB_GROUP)
  REFERENCES DBA_DIVAS.QRTZ_JOB_DETAILS (SCHED_NAME,
  JOB_NAME,
  JOB_GROUP)
)
STORAGE (INITIAL 64 K
...
CREATE TABLE DBA_DIVAS.REG_PRICES (
  ...
  REFERENCES DBA_DIVAS.NOMENKLATURA (ID) ON DELETE CASCADE,
  CONSTRAINT REG_PRICES_FK2 FOREIGN KEY (ED_IZM)
  REFERENCES DBA_DIVAS.MEASURE_UNIT (ID) ON DELETE SET NULL
)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
...
CREATE TABLE DBA_DIVAS.REG_RATES (
  ...
  REFERENCES DBA_DIVAS.CURRENCY (ID) ON DELETE CASCADE
)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
...
CREATE TABLE DBA_DIVAS.PAY_SETTINGS (
  ID          VARCHAR2(50 CHAR)  NOT NULL,
  NAME        VARCHAR2(50 CHAR)  NOT NULL,
  FULLNAME    VARCHAR2(100 CHAR) NOT NULL,
  ...
  REFERENCES DBA_DIVAS.BASE_OF_CALC (ID)
)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
...
CREATE TABLE DBA_DIVAS.CALL_LISTS (
  ...
  REFERENCES DBA_DIVAS.KONTRAGENTS (ID) ON DELETE CASCADE
)
LOGGING;
...
CREATE TABLE DBA_DIVAS.DIVISION_SOTR (
  ...
  REFERENCES DBA_DIVAS.DIVISIONS (ID) ON DELETE SET NULL,
...
CREATE TABLE DBA_DIVAS.MOVES (
  ...
  REFERENCES DBA_DIVAS.TYPE_OF_ACTIVITIES (ID),
...
CREATE INDEX DBA_DIVAS.MOVES_INDEX1 ON DBA_DIVAS.MOVES (PLAN_ACC_DEB_ID)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;

CREATE INDEX DBA_DIVAS.MOVES_INDEX10 ON DBA_DIVAS.MOVES (CURR_DEB)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;

CREATE INDEX DBA_DIVAS.MOVES_INDEX11 ON DBA_DIVAS.MOVES (CURR_KRED)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;

CREATE INDEX DBA_DIVAS.MOVES_INDEX12 ON DBA_DIVAS.MOVES (PERIOD)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;

CREATE INDEX DBA_DIVAS.MOVES_INDEX13 ON DBA_DIVAS.MOVES (PLAN_ACC_DEB_ID, DIVISION_ID)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;

CREATE INDEX DBA_DIVAS.MOVES_INDEX14 ON DBA_DIVAS.MOVES (PLAN_ACC_KRED_ID, DIVISION_ID)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;

CREATE INDEX DBA_DIVAS.MOVES_INDEX15 ON DBA_DIVAS.MOVES (REGISTRATOR_ID)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;

CREATE INDEX DBA_DIVAS.MOVES_INDEX16 ON DBA_DIVAS.MOVES (REGISTRATOR_TYPE)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;

CREATE INDEX DBA_DIVAS.MOVES_INDEX2 ON DBA_DIVAS.MOVES (PLAN_ACC_KRED_ID)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;

CREATE INDEX DBA_DIVAS.MOVES_INDEX3 ON DBA_DIVAS.MOVES (SUBCONTO1_DEB)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;

CREATE INDEX DBA_DIVAS.MOVES_INDEX4 ON DBA_DIVAS.MOVES (SUBCONTO2_DEB)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;

CREATE INDEX DBA_DIVAS.MOVES_INDEX5 ON DBA_DIVAS.MOVES (SUBCONTO3_DEB)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;

CREATE INDEX DBA_DIVAS.MOVES_INDEX6 ON DBA_DIVAS.MOVES (SUBCONTO1_KRED)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;

CREATE INDEX DBA_DIVAS.MOVES_INDEX7 ON DBA_DIVAS.MOVES (SUBCONTO2_KRED)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;

CREATE INDEX DBA_DIVAS.MOVES_INDEX8 ON DBA_DIVAS.MOVES (SUBCONTO3_KRED)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;

CREATE INDEX DBA_DIVAS.MOVES_INDEX9 ON DBA_DIVAS.MOVES (DIVISION_ID)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;
...
CREATE TABLE DBA_DIVAS.PLAN_ACC_SUBCONTO (
  ...
  REFERENCES DBA_DIVAS.PLAN_TYPE_SUBCONTO (ID)
)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
...
CREATE TABLE DBA_DIVAS.QRTZ_BLOB_TRIGGERS (
  ...
  TRIGGER_NAME,
  TRIGGER_GROUP)
  REFERENCES DBA_DIVAS.QRTZ_TRIGGERS (SCHED_NAME,
  TRIGGER_NAME,
  TRIGGER_GROUP)
)
LOGGING;
...
CREATE TABLE DBA_DIVAS.QRTZ_CRON_TRIGGERS (
  ...
  CONSTRAINT QRTZ_CRON_TRIG_PK PRIMARY KEY (SCHED_NAME, TRIGGER_NAME, TRIGGER_GROUP) USING INDEX STORAGE (INITIAL 64 K
                                                                                                          NEXT 1 M
                                                                                                          MAXEXTENTS UNLIMITED),
...
CREATE TABLE DBA_DIVAS.NACHISL_SETTINGS (
  ID          VARCHAR2(50 CHAR) NOT NULL,
  USER_ID     VARCHAR2(50 CHAR) NOT NULL,
  ...
  DIVISION_ID VARCHAR2(50 CHAR),
  SUMMA       NUMBER,
  CONSTRAINT NACHISL_SETTINGS_PK PRIMARY KEY (ID) USING INDEX STORAGE (INITIAL 64 K
                                                                       NEXT 1 M
                                                                       MAXEXTENTS UNLIMITED),
  CONSTRAINT NACHISL_SETTINGS_FK1 FOREIGN KEY (USER_ID)
  REFERENCES DBA_DIVAS.USERS (ID) ON DELETE CASCADE,
  CONSTRAINT NACHISL_SETTINGS_FK2 FOREIGN KEY (PAY_ID)
  REFERENCES DBA_DIVAS.PAY_SETTINGS (ID) ON DELETE CASCADE,
  CONSTRAINT NACHISL_SETTINGS_FK3 FOREIGN KEY (BASE_ID)
  REFERENCES DBA_DIVAS.BASE_OF_NACHISL (ID) ON DELETE CASCADE,
...
CREATE TABLE DBA_DIVAS.KONTRAG_SETTINGS (
  ID          VARCHAR2(50 CHAR) NOT NULL,
  KONTRAG_ID  VARCHAR2(50 CHAR) NOT NULL,
  PAY_ID      VARCHAR2(50 CHAR) NOT NULL,
  VERSION     TIMESTAMP(6)      DEFAULT systimestamp NOT NULL,
  ...
  REFERENCES DBA_DIVAS.PAY_SETTINGS (ID),
  CONSTRAINT KONTRAG_SETTINGS_FK3 FOREIGN KEY (BASE_ID)
  REFERENCES DBA_DIVAS.BASE_OF_NACHISL (ID),
  CONSTRAINT KONTRAG_SETTINGS_FK4 FOREIGN KEY (DIVISION_ID)
  REFERENCES DBA_DIVAS.DIVISIONS (ID)
)
STORAGE (INITIAL 64 K
         NEXT 1 M
...
CREATE TABLE DBA_DIVAS.START_OST (
  ID            VARCHAR2(50 CHAR) NOT NULL,
  DAT           DATE              DEFAULT sysdate NOT NULL,
...
CREATE INDEX DBA_DIVAS.START_OST_INDEX1 ON DBA_DIVAS.START_OST (DAT)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;

CREATE TABLE DBA_DIVAS.PROFIT_DISTRIB (
  ID            VARCHAR2(50 CHAR) NOT NULL,
  DAT           DATE              DEFAULT sysdate NOT NULL,
  NUM           VARCHAR2(50 CHAR) NOT NULL,
  DELETED       NUMBER(1, 0)      DEFAULT 0 NOT NULL,
  ...
  CONSTRAINT PROFIT_DISTRIB_PK PRIMARY KEY (ID) USING INDEX STORAGE (INITIAL 64 K
                                                                     NEXT 1 M
                                                                     MAXEXTENTS UNLIMITED),
...
CREATE INDEX DBA_DIVAS.PROFIT_DISTRIB_INDEX1 ON DBA_DIVAS.PROFIT_DISTRIB (DAT)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;
...
CREATE TABLE DBA_DIVAS.COMPAIGNS_DETAILS (
  ...
  VERSION     TIMESTAMP(6)      DEFAULT systimestamp NOT NULL,
  CONSTRAINT COMPAIGNS_DETAILS_PK PRIMARY KEY (ID) USING INDEX STORAGE (INITIAL 64 K
                                                                        NEXT 1 M
                                                                        MAXEXTENTS UNLIMITED),
  CONSTRAINT COMPAIGNS_DETAILS_FK1 FOREIGN KEY (COMPAIGN_ID)
  REFERENCES DBA_DIVAS.COMPAIGNS (ID) ON DELETE SET NULL,
  CONSTRAINT COMPAIGNS_DETAILS_FK2 FOREIGN KEY (KONTRAG_ID)
  REFERENCES DBA_DIVAS.KONTRAGENTS (ID) ON DELETE SET NULL,
  CONSTRAINT COMPAIGNS_DETAILS_FK3 FOREIGN KEY (CONTACT_ID)
  REFERENCES DBA_DIVAS.CONTACT_DETAILS (ID) ON DELETE SET NULL
)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
...
CREATE TABLE DBA_DIVAS.NOTIFICATION (
  ...
  REFERENCES DBA_DIVAS.CONTACT_DETAILS (ID) ON DELETE CASCADE
)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
...
CREATE TABLE DBA_DIVAS.ORDERS (
  ...
  REFERENCES DBA_DIVAS.ORDER_STATUS (ID) ON DELETE SET NULL,
...
CREATE INDEX DBA_DIVAS.ORDERS_INDEX1 ON DBA_DIVAS.ORDERS (DAT)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;

CREATE TABLE DBA_DIVAS.OTHER_ZATRATY (
  ID            VARCHAR2(50 CHAR) NOT NULL,
  DAT           DATE              DEFAULT sysdate NOT NULL,
  NUM           VARCHAR2(50 CHAR) NOT NULL,
  DELETED       NUMBER(1, 0)      DEFAULT 0 NOT NULL,
...
CREATE INDEX DBA_DIVAS.OTHER_ZATRATY_INDEX1 ON DBA_DIVAS.OTHER_ZATRATY (DAT)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;
...
CREATE TABLE DBA_DIVAS.KASSA_SETTINGS (
  ID       VARCHAR2(50 CHAR) NOT NULL,
  USER_ID  VARCHAR2(50 CHAR) NOT NULL,
  KASSA_ID VARCHAR2(50 CHAR) NOT NULL,
  ...
  REFERENCES DBA_DIVAS.KASSA (ID) ON DELETE CASCADE
)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
...
CREATE TABLE DBA_DIVAS.START_OST_TP (
  ID               VARCHAR2(50 CHAR) NOT NULL,
  PLAN_ACC_DEB_ID  VARCHAR2(50 CHAR) NOT NULL,
  SUBCONTO1_DEB    VARCHAR2(50 CHAR),
  SUBCONTO2_DEB    VARCHAR2(50 CHAR),
  ...
  REFERENCES DBA_DIVAS.START_OST (ID) ON DELETE CASCADE
)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
...
CREATE INDEX DBA_DIVAS.START_OST_TP_INDEX1 ON DBA_DIVAS.START_OST_TP (START_OST_ID)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;

CREATE TABLE DBA_DIVAS.PROFIT_DISTRIB_TP (
  ID          VARCHAR2(50 CHAR) NOT NULL,
  ...
  CONSTRAINT PROFIT_DISTRIB_TP_PK PRIMARY KEY (ID) USING INDEX STORAGE (INITIAL 64 K
                                                                        NEXT 1 M
                                                                        MAXEXTENTS UNLIMITED),
  CONSTRAINT PROFIT_DISTRIB_TP_FK1 FOREIGN KEY (PROFIT_ID)
  REFERENCES DBA_DIVAS.PROFIT_DISTRIB (ID),
...
CREATE INDEX DBA_DIVAS.PROFIT_DISTRIB_TP_INDEX1 ON DBA_DIVAS.PROFIT_DISTRIB_TP (PROFIT_ID)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;
...
CREATE TABLE DBA_DIVAS.CALL_LOG (
  ...
  KONTRAG_ID   VARCHAR2(50 CHAR),
  CONSTRAINT CALL_LOG_PK PRIMARY KEY (ID) USING INDEX STORAGE (INITIAL 64 K
                                                               NEXT 1 M
                                                               MAXEXTENTS UNLIMITED),
  CONSTRAINT CALL_LOG_FK1 FOREIGN KEY (CALL_STATUS)
  REFERENCES DBA_DIVAS.CALL_STATUS (ID) ON DELETE SET NULL,
  CONSTRAINT CALL_LOG_FK2 FOREIGN KEY (CONTACT_ID)
  REFERENCES DBA_DIVAS.CONTACT_DETAILS (ID) ON DELETE CASCADE,
  CONSTRAINT CALL_LOG_FK3 FOREIGN KEY (COMP_DET_ID)
  REFERENCES DBA_DIVAS.COMPAIGNS_DETAILS (ID),
  CONSTRAINT CALL_LOG_FK4 FOREIGN KEY (CALL_RESULTS)
  REFERENCES DBA_DIVAS.CALL_RESULTS (ID),
...
CREATE TABLE DBA_DIVAS.ORDERS_TP_NACHISL (
  ID          VARCHAR2(50 CHAR) NOT NULL,
...
CREATE INDEX DBA_DIVAS.ORDERS_TP_NACHISL_INDEX1 ON DBA_DIVAS.ORDERS_TP_NACHISL (ORDER_ID)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;
...
CREATE INDEX DBA_DIVAS.ORDERS_TP_OPLATY_INDEX1 ON DBA_DIVAS.ORDERS_TP_OPLATY (ORDER_ID)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;

CREATE TABLE DBA_DIVAS.ORDERS_TP_RASHODY (
  ID          VARCHAR2(50 CHAR) NOT NULL,
  ORDER_ID    VARCHAR2(50 CHAR) NOT NULL,
...
CREATE INDEX DBA_DIVAS.ORDERS_TP_RASHODY_INDEX1 ON DBA_DIVAS.ORDERS_TP_RASHODY (ORDER_ID)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;
...
CREATE TABLE DBA_DIVAS.ORDERS_TP_USLUGI (
  ...
  REFERENCES DBA_DIVAS.NOMENKLATURA (ID) ON DELETE SET NULL,
  ...
  REFERENCES DBA_DIVAS.MEASURE_UNIT (ID)
)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
...
CREATE INDEX DBA_DIVAS.ORDERS_TP_USLUGI_INDEX1 ON DBA_DIVAS.ORDERS_TP_USLUGI (ORDER_ID)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;

CREATE TABLE DBA_DIVAS.OTHER_ZATRATY_TAB_PART_ZATRATY (
  ID      VARCHAR2(50 CHAR) NOT NULL,
  ...
  REFERENCES DBA_DIVAS.OTHER_ZATRATY (ID) ON DELETE CASCADE,
  CONSTRAINT OTHER_ZATRATY_TAB_PART_ZA_FK2 FOREIGN KEY (ZATR_ID)
  REFERENCES DBA_DIVAS.ZATRATY (ID) ON DELETE SET NULL
)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
...
CREATE TABLE DBA_DIVAS.RKO (
  ...
  REFERENCES DBA_DIVAS.OPERATION_RKO (ID),
  ...
  REFERENCES DBA_DIVAS.ORDERS (ID)
)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
...
CREATE INDEX DBA_DIVAS.RKO_INDEX1 ON DBA_DIVAS.RKO (DAT)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;

CREATE TABLE DBA_DIVAS.PKO (
  ID            VARCHAR2(50 CHAR) NOT NULL,
  DAT           DATE              DEFAULT sysdate NOT NULL,
  NUM           VARCHAR2(50 CHAR) NOT NULL,
  DELETED       NUMBER(1, 0)      DEFAULT 0 NOT NULL,
  ...
  REFERENCES DBA_DIVAS.OPERATION_PKO (ID),
...
CREATE INDEX DBA_DIVAS.PKO_INDEX1 ON DBA_DIVAS.PKO (DAT)
STORAGE (INITIAL 64 K
         NEXT 1 M
         MAXEXTENTS UNLIMITED)
LOGGING;
...
CREATE TABLE DBA_DIVAS.CALL_MEMO (
  ...
  REFERENCES DBA_DIVAS.CALL_LOG (ID)
)
LOGGING;

CREATE OR REPLACE PACKAGE DBA_DIVAS."CURRENCY_PKG"
  AS
...
CREATE OR REPLACE PACKAGE BODY DBA_DIVAS."CURRENCY_PKG"
  AS
...
CREATE OR REPLACE PACKAGE DBA_DIVAS."ENTRY"
  AS
...
CREATE OR REPLACE PACKAGE BODY DBA_DIVAS."ENTRY"
  AS
...
CREATE OR REPLACE PACKAGE DBA_DIVAS."FTP"
  AS
  -- --------------------------------------------------------------------------
...
CREATE OR REPLACE PACKAGE BODY DBA_DIVAS."FTP"
  AS
  -- --------------------------------------------------------------------------
...
CREATE OR REPLACE PACKAGE DBA_DIVAS."KONTRAG"
  AS
...
CREATE OR REPLACE PACKAGE BODY DBA_DIVAS."KONTRAG"
  AS
...
CREATE OR REPLACE PACKAGE DBA_DIVAS."USR_SETT"
  AS
...
CREATE OR REPLACE PACKAGE BODY DBA_DIVAS."USR_SETT"
  AS
...
CREATE OR REPLACE PACKAGE DBA_DIVAS."UTILITY"
  AS
...
CREATE OR REPLACE PACKAGE BODY DBA_DIVAS."UTILITY"
  AS
...
CREATE OR REPLACE PACKAGE DBA_DIVAS."PRICES"
  AS
...
CREATE OR REPLACE PACKAGE BODY DBA_DIVAS."PRICES"
  AS
...
CREATE OR REPLACE PACKAGE DBA_DIVAS."ORDERS_ENTRY"
  AS
...
CREATE OR REPLACE PACKAGE BODY DBA_DIVAS."ORDERS_ENTRY"
  AS
...
CREATE OR REPLACE PACKAGE DBA_DIVAS."OTHER_ENTRY"
  AS
...
CREATE OR REPLACE PACKAGE BODY DBA_DIVAS."OTHER_ENTRY"
  AS
...
CREATE OR REPLACE PACKAGE DBA_DIVAS."REPORT_PKG"
  AS
...
CREATE OR REPLACE PACKAGE BODY DBA_DIVAS."REPORT_PKG"
  AS
...
CREATE OR REPLACE PACKAGE DBA_DIVAS."RKO_ENTRY"
  AS
...
CREATE OR REPLACE PACKAGE BODY DBA_DIVAS."RKO_ENTRY"
  AS
...
CREATE OR REPLACE PACKAGE DBA_DIVAS."PKO_ENTRY"
  AS
...
CREATE OR REPLACE PACKAGE BODY DBA_DIVAS."PKO_ENTRY"
  AS
...
CREATE OR REPLACE PACKAGE DBA_DIVAS."PAYCALC"
  AS
...
CREATE OR REPLACE PACKAGE BODY DBA_DIVAS."PAYCALC"
  AS
      ...
      LOOP
        ...
        LOOP
          ...
          LOOP
            ...
            THEN
              FOR g IN (SELECT *
                  FROM TABLE (CAST(get_kont_by_division(p_order) AS kontragTable))
                  WHERE n = y.id
                    AND ROWNUM = 1)
              LOOP
                nachisl_rec.order_id := p_order;
...
CREATE OR REPLACE PACKAGE DBA_DIVAS."START_PKG"
  AS
...
CREATE OR REPLACE PACKAGE BODY DBA_DIVAS."START_PKG"
  AS
...
CREATE OR REPLACE PACKAGE DBA_DIVAS."PROFIT_ENTRY"
  AS
...
CREATE OR REPLACE PACKAGE BODY DBA_DIVAS."PROFIT_ENTRY"
  AS
  ...
  PROCEDURE set_subconto_division(p_move_rec moves % ROWTYPE)
    ...
    BEGIN
      ...
      FOR i IN (SELECT *
          FROM vw_ballans
          WHERE code LIKE '900'
          ORDER BY end_ost ASC)
      LOOP
        -- p_summ:=p_summ - i.end_ost;
        IF i.DIVISION_ID = p_profit.division_id
        THEN
          CONTINUE;
        END IF;
        p_ret_rec := p_move_rec;
...
CREATE OR REPLACE FUNCTION DBA_DIVAS."ACC_TYPE_CONV"(bl_expr IN VARCHAR2)
  RETURN VARCHAR2
  AS
  BEGIN
...
CREATE OR REPLACE FUNCTION DBA_DIVAS."BOOL_TO_NUM"(bl_expr IN VARCHAR2)
  RETURN NUMBER
  AS
  BEGIN
...
CREATE OR REPLACE FUNCTION DBA_DIVAS."PLAN_TYPE_SUBCONTO_CONV"(bl_expr IN VARCHAR2)
  RETURN VARCHAR2
  AS
    p_ref VARCHAR2(50);
  BEGIN
...
CREATE OR REPLACE FUNCTION DBA_DIVAS."GET_USERS"(p_u_name IN VARCHAR2)
  RETURN userTable
  IS
...
CREATE OR REPLACE FUNCTION DBA_DIVAS."GET_DIVISIONS"(p_u_name IN VARCHAR2)
...
CREATE OR REPLACE FUNCTION DBA_DIVAS."GET_USERS_FOR_ZAMER"(p_u_name IN VARCHAR2)
  RETURN userTable
  IS
    l_data    userTable := userTable();
    p_idrole  NUMBER;
...
CREATE OR REPLACE VIEW DBA_DIVAS.LAST_PRICES (
  ID,
  NOM_ID,
  PERIOD,
  ED_IZM,
...
CREATE OR REPLACE VIEW DBA_DIVAS.VW_MOVES (
  ID,
  REGISTRATOR_ID,
  TABLE_NAME,
  DEB,
...
CREATE OR REPLACE VIEW DBA_DIVAS.VW_NOTIFICATION_CALENDAR (
  ID,
  SCHED_NAME,
  JOB_NAME,
  JOB_GROUP,
...
CREATE OR REPLACE VIEW DBA_DIVAS.ORDERS_CALC (
  ID,
  KONTRAG_ID,
  KONTRAGNAME,
  DIVISION_ID,
...
CREATE OR REPLACE VIEW DBA_DIVAS.VW_RATING (
  PLACE,
  DIVISION_ID,
  CNT,
  TOTAL,
...
CREATE OR REPLACE VIEW DBA_DIVAS.VW_TBL_DEL_REF (
  TABLE_ID,
  MAIN_ID,
  TABLE_NAME,
  COLUMN_NAME,
...
CREATE OR REPLACE VIEW DBA_DIVAS.VW_TBL_DELETED (
  TABLE_ID,
  MAIN_ID,
  TABLE_NAME,
  COLUMN_NAME,
...
CREATE OR REPLACE VIEW DBA_DIVAS.VW_MOVE_ORDERS (
  REGISTRATOR_ID,
  DEB,
  SUM_DEB,
  KRED,
...
CREATE OR REPLACE VIEW DBA_DIVAS.OBOROT_MOVIES_KRED (
  PLAN_ACC_ID,
  KRED,
  SUM_KRED,
  SUBCONTO1_KRED,
...
CREATE OR REPLACE VIEW DBA_DIVAS.OBOROT_MOVIES_DEB (
  PLAN_ACC_ID,
  DEB,
  SUM_DEB,
  SUBCONTO1_DEB,
...
CREATE OR REPLACE VIEW DBA_DIVAS.MOVE_KONTRAG (
  KONTRAG_ID,
  KONTRAG,
  CODE,
  SUMM,
...
CREATE OR REPLACE VIEW DBA_DIVAS.MOVE_KASSA (
  ID,
  KASSA_ID,
  KASSA,
  CODE,
...
CREATE OR REPLACE VIEW DBA_DIVAS.OBOROT_600 (
  REGISTRATOR_ID,
  DEB,
  SUM_DEB,
  KRED,
...
CREATE OR REPLACE VIEW DBA_DIVAS.VW_MOVE_OTHER (
  REGISTRATOR_ID,
  DEB,
  SUM_DEB,
  KRED,
...
CREATE OR REPLACE VIEW DBA_DIVAS.VW_SEBEST_ORDERS (
  REGISTRATOR_ID,
  TABLE_NAME,
  CODE,
  SUMMA,
...
CREATE OR REPLACE VIEW DBA_DIVAS.VW_SALES_ORDERS (
  REGISTRATOR_ID,
  TABLE_NAME,
  CODE,
  SUMMA,
...
CREATE OR REPLACE VIEW DBA_DIVAS.VW_ZATRATY (
  REGISTRATOR_ID,
  TABLE_NAME,
  CODE,
  SUMMA,
...
CREATE OR REPLACE VIEW DBA_DIVAS.VW_MOVE_PKO (
  REGISTRATOR_ID,
  DEB,
  SUM_DEB,
  KRED,
...
CREATE OR REPLACE VIEW DBA_DIVAS.VW_MOVE_RKO (
  REGISTRATOR_ID,
  DEB,
  SUM_DEB,
  KRED,
  ...
  SUBCONTO_KRED1
    ...
    SELECT VW_MOVES.REGISTRATOR_ID,
           ...
           VW_MOVES.KRED,
           VW_MOVES.SUM_KRED,
           CASE WHEN KONTRAGENTS.FULLNAME IS NULL THEN (SELECT fullname
                     FROM kassa
                     WHERE id = VW_MOVES.SUBCONTO1_DEB) ELSE KONTRAGENTS.FULLNAME END AS Subconto_Deb1,
...
CREATE OR REPLACE VIEW DBA_DIVAS.VW_MOVE_START_OST (
  REGISTRATOR_ID,
  DEB,
  SUM_DEB,
  SUBCONTO1_DEB,
...
CREATE OR REPLACE VIEW DBA_DIVAS.VW_MOVE_PROFIT (
  REGISTRATOR_ID,
  DEB,
  SUM_DEB,
  KRED,
...
CREATE OR REPLACE VIEW DBA_DIVAS.OBOROT_MOVIES (
  ID,
  ACC_TYPE,
  PARENT_ID,
  FULLNAME,
...
CREATE OR REPLACE VIEW DBA_DIVAS.VW_SALES (
  ORDER_ID,
  KONTRAG_ID,
  PERIOD,
  DIVISION_ID,
...
CREATE OR REPLACE VIEW DBA_DIVAS.VW_BALLANS (
  ID,
  PARENT_ID,
  ACC_TYPE,
  ACTIVE_PASSIVE,
...
CREATE OR REPLACE VIEW DBA_DIVAS.VW_BALLANS_AP (
  ID,
  CODE,
  FULLNAME,
  ACTIVE_START,
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.BASE_OF_CALC_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.BASE_OF_CALC
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.BASE_OF_NACHISL_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.BASE_OF_NACHISL
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.CALL_LISTS_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.CALL_LISTS
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.CALL_MEMO_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.CALL_MEMO
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.CDR_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.CDR
  FOR EACH ROW
BEGIN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.COMPAIGNS_DETAILS_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.COMPAIGNS_DETAILS
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.DIR_FILE_UPLOAD_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.DIR_FILE_UPLOAD
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.ENUM_ACCOUNT_TYPE_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.ENUM_ACCOUNT_TYPE
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.EX_RATES_SETTINGS_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.EX_RATES_SETTINGS
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.KASSA_SETTINGS_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.KASSA_SETTINGS
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.KONTRAG_SETTINGS_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.KONTRAG_SETTINGS
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.NACHISL_SETTINGS_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.NACHISL_SETTINGS
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.NOTIFICATION_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.NOTIFICATION
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.OPERATION_PKO_TGR
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.OPERATION_PKO
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.OPERATION_RKO_TGR
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.OPERATION_RKO
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
    ...
    THEN
      ...
      THEN
        SELECT orders_num_seq.NEXTVAL
          ...
          FROM dual;
      ELSE
        SELECT l_num || orders_num_seq.NEXTVAL
          INTO :new."NUM"
          FROM dual;
      END IF;
    END IF;
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.ORDERS_TP_NACHISL_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.ORDERS_TP_NACHISL
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.ORDERS_TP_OPLATY_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.ORDERS_TP_OPLATY
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.ORDERS_TP_RASHODY_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.ORDERS_TP_RASHODY
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.OTHER_ZATRATY_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.OTHER_ZATRATY
  FOR EACH ROW
DECLARE
  l_rec type_def % ROWTYPE;
  l_num numerator.prefix % TYPE;
    ...
    THEN
      ...
      THEN
        SELECT other_zatr_num_seq.NEXTVAL
          ...
          FROM dual;
      ELSE
        SELECT l_num || other_zatr_num_seq.NEXTVAL
          INTO :new."NUM"
          FROM dual;
      END IF;
    END IF;
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.OTHER_ZATR_TP_ZATRATY_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.OTHER_ZATRATY_TAB_PART_ZATRATY
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.PAY_SETTINGS_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.PAY_SETTINGS
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.PKO_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.PKO
  FOR EACH ROW
DECLARE
    ...
    THEN
      ...
      THEN
        SELECT pko_num_seq.NEXTVAL
          ...
          FROM dual;
      ELSE
        SELECT l_num || pko_num_seq.NEXTVAL
          INTO :new."NUM"
          FROM dual;
      END IF;
    END IF;
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.PLAN_ACC_SUBCONTO_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.PLAN_ACC_SUBCONTO
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.PLAN_TYPE_SUBCONTO_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.PLAN_TYPE_SUBCONTO
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.PROFIT_DISTRIB_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.PROFIT_DISTRIB
  FOR EACH ROW
DECLARE
  l_rec type_def % ROWTYPE;
  l_num numerator.prefix % TYPE;
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.PROFIT_DISTRIB_TP_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.PROFIT_DISTRIB_TP
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.PROG_SETTINGS_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.PROG_SETTINGS
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.JOB_END_TRG
  BEFORE UPDATE OR DELETE
  ON DBA_DIVAS.QRTZ_TRIGGERS
BEGIN
  IF DELETING
    OR UPDATING
  THEN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.QUARTZ_PROPERTY_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.QUARTZ_PROPERTY
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.RATING_SETTINGS_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.RATING_SETTINGS
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.REG_PRICES_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.REG_PRICES
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.RKO_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.RKO
  FOR EACH ROW
DECLARE
    ...
    THEN
      ...
      THEN
        SELECT rko_num_seq.NEXTVAL
          ...
          FROM dual;
      ELSE
        SELECT l_num || rko_num_seq.NEXTVAL
          INTO :new."NUM"
          FROM dual;
      END IF;
    END IF;
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.START_OST_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.START_OST
  FOR EACH ROW
DECLARE
  l_rec type_def % ROWTYPE;
  l_num numerator.prefix % TYPE;
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.START_OST_TP_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.START_OST_TP
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.TYPE_OF_ACTIVITIES_TGR
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.TYPE_OF_ACTIVITIES
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.USERS_GROUPS_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.USERS_GROUPS
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
...
CREATE OR REPLACE TRIGGER DBA_DIVAS.WLS_SETTINGS_TRG
  BEFORE INSERT OR UPDATE
  ON DBA_DIVAS.WLS_SETTINGS
  FOR EACH ROW
BEGIN
  IF inserting
  THEN
